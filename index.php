...
<body id="page-top" class="index">
 ...
 RODO</a>
    ...
    <section id="portfolio" class="" style="height: auto;">
        <div class="container shadoww" style="background-color: #cccccc;">
            <div class="row">
    ...
    <section id="about" >
        <div class="container shadoww" style="height: auto;background-color: #cccccc;">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Licytacje</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 text-center">
    ...
    <section id="wplaty" style="height: auto;">
    ...
    <section id="contact" style="background-color: white;">
        <div class="container"  >
            ...
            <div class="row" style="font-size: 14px;">
                ...
                <div class="col-md-4 col-sm-4 portfolio-item text-center shadoww phon">
                    <span class="fa-stack fa-5x">
                        <i class="fa fa-envelope" aria-hidden="true" style="color:#a20000"></i>
                </span>
                <h4 style="font-weight: bold;">krakow.cukier@komornik.pl</h4> <br>
    ...
    <section id="rodo" style="background-color: white; height: auto;">
        ...
        <div class="container shadoww" style="background-color: #cccccc;">
            ...
            <div class="col-md-6 col-sm-6 portfolio-item just phon">
                <p style="color: black;">Komornik przetwarza dane osobowe na podstawie obowiązku prawnego ciążącego na administratorze (przetwarzanie w związku z ustawą z dnia 22 marca 2018 r. o komornikach sądowych Dz.U. 2018 poz. 771). Klauzula informacyjna do pobrania.</p>
            </div>
...
© 2021 Komornik Sądowy Krzysztof Cukier
    ...
    <!--
    <div class="Cookies" style="right: 20px;">
        ...
        <br>
        <div class="przyciski">
            <button class="item">Rozumiem</button>
        <a href="/polityka-prywatnosci-i-plikow-cookies/" style="color:#fff; text-decoration: none; font-size: 14px; display:inline-block; padding:10px 0;">
            Dowiedz się więcej.
        </a>
    </div>
    </div>
    ...
    <div class="Cookies1">
        <div class="info1">
          ...
          <div class="przyciski1">
            <button class="item1">Rozumiem</button>
            <a href="#" class="item1">Dowiedz się więcej</a>
          </div>
        </div>
      </div>
-->
